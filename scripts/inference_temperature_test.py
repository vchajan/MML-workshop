...
PROJECT = Path(".")
MODEL_PATH = PROJECT / "models/codebook_colorizer/best.pt"
CODEBOOK_PATH = PROJECT / "models/codebook/ab_codebook_256.npz"
INPUT_DIR = PROJECT / "input_images"
OUT_DIR = PROJECT / "outputs/inference_temperature_test"
