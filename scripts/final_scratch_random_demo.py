...
def main():
    ...
    parser.add_argument("--model", default="models/codebook_colorizer_scratch_v2/best.pt")
    parser.add_argument("--out-dir", default="outputs/final_scratch_v2_demo")
    ...
    for i, p in enumerate(selected, 1):
        ...
        pred_l = add_label(pred, "model prediction")
    ...
    grid_path = out_dir / "final_scratch_v2_random_grid.png"
    grid.save(grid_path)
